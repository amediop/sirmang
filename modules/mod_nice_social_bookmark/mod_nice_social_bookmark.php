...
$googlewidth = $params->get("googlewidth");
$p=array();
...
if ($tt == "1")
{
    ...
    $h[] = '<a id="l1" class="icons" target="_blank" '.$follower.' href="https://www.facebook.com/sharer.php?u='.$url.'&amp;title='.$title.'"><img title="Facebook" src="modules/mod_nice_social_bookmark/icons/facebook_'.$iset.'_'.$isize.'.png" alt="Facebook" /></a>';
    }
    else{
    $p[] = $params->get('counter1');
    $h[] = '<a id="l1" class="icons" target="_blank" '.$follower.' href="https://'.$fblink.'"><img title="Facebook" src="modules/mod_nice_social_bookmark/icons/facebook_'.$iset.'_'.$isize.'.png" alt="Facebook" /></a>';
    }
}
...
if ($tt == "1")
{
    ...
    <a id="l3" class="icons" target="_blank" '.$follower.' href="https://twitter.com/share?url='.$url.'&amp;"><img title="Twitter" src="modules/mod_nice_social_bookmark/icons/twitter_'.$iset.'_'.$isize.'.png" alt="Twitter" /></a>';
    }
    else{
    $p[] = $params->get('counter3');
    $h[] = '<a id="l3" class="icons" target="_blank" '.$follower.' href="https://'.$twlink.'"><img title="Twitter" src="modules/mod_nice_social_bookmark/icons/twitter_'.$iset.'_'.$isize.'.png" alt="Twitter" /></a>';
    }
}
