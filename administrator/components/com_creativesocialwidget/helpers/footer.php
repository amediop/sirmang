<?php
/**
 * Joomla! component Creative Social Widget
 *
...
<table class="adminlist" style="width: 100%;margin-top: 12px;clear: both;"><tr><td align="center" valign="middle" id="twoglux_ext_td" style="position: relative;height: 70px;">
	<div style="color: #0561AC;font-size: 14px;margin: 13px 0 -3px 10px;font-weight: normal;font-style: italic;">Upgrading from <b style="text-decoration: underline;">Free</b> to <b style="text-decoration: underline;">Commercial</b> is easy! It will take only <a href="<?php echo JText::_( 'COM_CREATIVESOCIALWIDGET_SUBMENU_BUY_PRO_VERSION_LINK' ); ?>" target="_blank" style="color: rgb(214, 0, 0);font-weight: bold;text-decoration: underline;">5 minutes!</a></div>
	<div id="twoglux_bottom_link"><a href="<?php echo JText::_( 'COM_CREATIVESOCIALWIDGET_SUBMENU_PROJECT_HOMEPAGE_LINK' ); ?>" target="_blank"><?php echo JText::_( 'COM_CREATIVESOCIALWIDGET' ); ?></a> <?php echo JText::_( 'COM_CREATIVESOCIALWIDGET_DEVELOPED_BY' ); ?> <a href="http://creative-solutions.net" target="_blank">Creative-Solutions.net</a></div>
	<div style="position: absolute;right: 2px;top: 19px;">
		<a href="<?php echo JText::_( 'COM_CREATIVESOCIALWIDGET_SUBMENU_RATE_US_LINK' ); ?>" target="_blank" id="twoglux_ext_rate" class="twoglux_ext_bottom_icon" title="<?php echo JText::_( 'COM_CREATIVESOCIALWIDGET_SUBMENU_RATE_US_DESCRIPTION' ); ?>">&nbsp;</a>
		<a href="<?php echo JText::_( 'COM_CREATIVESOCIALWIDGET_SUBMENU_PROJECT_HOMEPAGE_LINK' ); ?>" target="_blank" id="twoglux_ext_homepage" style="margin: 0 2px 0 0px;" class="twoglux_ext_bottom_icon" title="<?php echo JText::_( 'COM_CREATIVESOCIALWIDGET_SUBMENU_PROJECT_HOMEPAGE_DESCRIPTION' ); ?>">&nbsp;</a>
		<a href="<?php echo JText::_( 'COM_CREATIVESOCIALWIDGET_SUBMENU_SUPPORT_FORUM_LINK' ); ?>" target="_blank" id="twoglux_ext_support" class="twoglux_ext_bottom_icon" title="<?php echo JText::_( 'COM_CREATIVESOCIALWIDGET_SUBMENU_SUPPORT_FORUM_DESCRIPTION' ); ?>">&nbsp;</a>
		<a href="<?php echo JText::_( 'COM_CREATIVESOCIALWIDGET_SUBMENU_BUY_PRO_VERSION_LINK' ); ?>" target="_blank" id="twoglux_ext_buy" class="twoglux_ext_bottom_icon" title="<?php echo JText::_( 'COM_CREATIVESOCIALWIDGET_SUBMENU_BUY_PRO_VERSION_DESCRIPTION' ); ?>">&nbsp;</a>
	</div>
</td></tr></table>
...
$jsFile = JURI::base(true).'/components/com_creativesocialwidget/assets/js/footer.js';
$document->addScript($jsFile);

$cssFile = JURI::base(true).'/components/com_creativesocialwidget/assets/css/creative_buttons.css';
$document->addStyleSheet($cssFile, 'text/css', null, array());

?>

<?php 
$similar_visible = rand(0,10) < 5 ? true : false;
?>
...
<?php $sim_ext_path = JURI::base(true).'/components/com_creativesocialwidget/assets/images/similar_extensions/';?>
		...
		<div class="twog_extension_wrapper" id="sim_ext_1" roll="1">
			...
			<div class="twog_extension_wrapper_inner">
				<div class="ext_top_wrapper">
					<a href="http://creative-solutions.net/joomla/creative-contact-form" target="_blank" class="sim_ext_link">Creative Contact Form</a>
					<img  class="sim_img_popular" title="Popular" alt="Popular" src="<?php echo $sim_ext_path;?>jed_status_popular.png" />
				</div>
				<a href="http://creative-solutions.net/joomla/creative-contact-form" target="_blank" class="sim_ext_link"><img class="sim_ext_img" src="<?php echo $sim_ext_path;?>creative-contact-form.png" /></a>
				<div class="sim_line1">
					...
					<div style="display: inline-block;">
						...
						<img class="sim_img_star" title="" alt="" src="<?php echo $sim_ext_path;?>star_10.png" style="margin-left: -4px;" />
						<img class="sim_img_star" title="" alt="" src="<?php echo $sim_ext_path;?>star_10.png" style="margin-left: -4px;" />
						<img class="sim_img_star" title="" alt="" src="<?php echo $sim_ext_path;?>star_05.png" style="margin-left: -4px;" />
					</div>
				...
				<div class="sim_ext_desc">
					...
					<br />It is packed with a Template Creator wizard to create fanstastic contact forms in a matter of seconds without coding.
				</div>
				
				<div class="sim_links">
					<a style="" target="_blank" href="http://creative-solutions.net/joomla/creative-contact-form/demo" class="creative_btn creative_btn-green creative_btn-mini"><i class="creative_icon-white creative_icon-play"></i> Live Demo</a>
					<a style="" target="_blank" href="http://creative-solutions.net/joomla/creative-contact-form" class="creative_btn creative_btn-red creative_btn-mini"><i class="creative_icon-white creative_icon-download"></i> Download</a>
				</div>
